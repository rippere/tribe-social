...
<!-- Generated: 2026-09-15 | Scope: monorepo | Token estimate: ~650 -->
...
- **TRIBE v2 (Meta FAIR)** — the brain-encoding model. Licensed **CC-BY-NC** → see `NOTICE` (commercial path = self-trained VIBE on CC0).
...
- Git hooks (in `.git/hooks/`, not versioned): pre-commit credential scan; pre-push unrelated-history guard.
